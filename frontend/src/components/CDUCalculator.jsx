        ...
        <div className="max-w-4xl mx-auto">
          ...
          {result && (
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
              ...
              {gruenenResult && gruenenResult.totalYears > 0 && (
                <GruenenReminder result={gruenenResult} birthYear={birthYear} />
              )}
              <Timeline periods={result.periods} birthYear={parseInt(birthYear)} partyName="CDU" />
            </div>
          )}
        </div>
      </main>
